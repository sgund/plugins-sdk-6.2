...
public class HostPersistenceImpl extends BasePersistenceImpl<Host>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G = new FinderPath(HostModelImpl.ENTITY_CACHE_ENABLED,
			HostModelImpl.FINDER_CACHE_ENABLED, HostImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G = new FinderPath(HostModelImpl.ENTITY_CACHE_ENABLED,
			HostModelImpl.FINDER_CACHE_ENABLED, HostImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG",
			new String[] { Long.class.getName() },
			HostModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G = new FinderPath(HostModelImpl.ENTITY_CACHE_ENABLED,
			HostModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Host> findByG(long groupId) throws SystemException {
	 ...
	 */
	@Override
	public List<Host> findByG(long groupId, int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public Host findByG_First(long groupId, OrderByComparator orderByComparator)
		throws NoSuchHostException, SystemException {
		Host host = fetchByG_First(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Host fetchByG_First(long groupId, OrderByComparator orderByComparator)
		throws SystemException {
		List<Host> list = findByG(groupId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Host findByG_Last(long groupId, OrderByComparator orderByComparator)
		throws NoSuchHostException, SystemException {
		Host host = fetchByG_Last(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Host fetchByG_Last(long groupId, OrderByComparator orderByComparator)
		throws SystemException {
		...
		List<Host> list = findByG(groupId, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public Host[] findByG_PrevAndNext(long hostId, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchHostException, SystemException {
		Host host = findByPrimaryKey(hostId);
		...
		try {
			...
			array[0] = getByG_PrevAndNext(session, host, groupId,
					orderByComparator, true);

			array[1] = host;

			array[2] = getByG_PrevAndNext(session, host, groupId,
					orderByComparator, false);
	...
	protected Host getByG_PrevAndNext(Session session, Host host, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByG(long groupId) throws SystemException {
		for (Host host : findByG(groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(host);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_GROUPID_2 = "host.groupId = ?";
